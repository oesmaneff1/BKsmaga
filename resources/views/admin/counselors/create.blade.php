...
@section('breadcrumb', 'Tim BK / Tambah')
...
<div class="card">
    <div class="card-header">
        <h2>👤 Form Konselor Baru</h2>
        <span style="font-size:.8rem;color:#6b7280;">Isi semua field bertanda <span style="color:#ef4444;">*</span></span>
    </div>
    ...
    <form id="main-form"
            ...
            <div class="form-group" style="margin-bottom:0;">
                ...
                <div style="position:relative;">
                    <select id="specialization" name="specialization"
                            ...
                            required>
                        <option value="" disabled {{ old('specialization') ? '' : 'selected' }}>-- Pilih Jabatan --</option>
        ...
        <div class="form-group">
            ...
            <div style="display:flex;align-items:flex-start;gap:1.25rem;margin-bottom:1rem;
                ...
                <div style="flex-shrink:0;width:66px;height:88px;border-radius:.75rem;
                            ...
                            font-size:1.8rem;box-shadow:0 4px 12px rgba(0,0,0,.15);">
                    🖼
                </div>
                <div style="font-size:.82rem;color:#374151;line-height:1.6;">
                    ...
                    <div>Foto akan ditampilkan sebagai <strong>background penuh kartu</strong> berukuran <strong>220 × 300 px</strong> (rasio 3:4, potret).</div>
                    <div style="margin-top:.35rem;">
                        ✅ <strong>Rasio ideal</strong>: 3:4 (potret) &nbsp;|&nbsp;
                        ✅ <strong>Resolusi min</strong>: 440 × 600 px &nbsp;|&nbsp;
                        ✅ <strong>Maks. 5MB</strong>
                    </div>
                    <div style="margin-top:.35rem;color:#6b7280;">
                        Format: JPG, PNG, WEBP &nbsp;·&nbsp; Foto wajah menghadap ke depan disarankan agar terlihat optimal.
                    </div>
                </div>
            </div>
        ...
        <div style="display:flex;align-items:center;gap:1.5rem;flex-wrap:wrap;">
            <div class="toggle-wrap">
                ...
                <span style="font-size:.875rem;font-weight:600;color:#374151;">Aktifkan Konselor</span>
            </div>
