...
<style>
    ...
    ──────────────────────────────────────────────────────────────── */
    .hero-slide-1 {
        background-image: url("{{ asset('images/gambar-slide1.jpeg') }}?v=1.1");
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
    }
    .hero-slide-2 {
        background-image: url("{{ asset('images/gambar-slide2.jpeg') }}?v=1.1");
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
    }
    .hero-slide-3 {
        background-image: url("{{ asset('images/gambar-slide3.jpeg') }}?v=1.1");
        background-size: cover;
        background-position: center;
        background-repeat: no-repeat;
    }
